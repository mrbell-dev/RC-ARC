...
aliases:
 - "/events/field-day/"
date: 2027-07-26 # this date is used by the archives
...
build: # https://gohugo.io/content-management/build-options/
 list: always # Controls whether and where a page appears in site page collections.  Always (def.), local, or never
...
Join the Rowan Amateur Radio Society for **ARRL Field Day 2027** -- a full weekend dedicated to the art and science of amateur radio. Field Day is amateur radio's largest on-air event, bringing together radio amateurs, hobbyists, students, and curious newcomers to set up stations, make contacts across the country, and demonstrate how hams communicate when traditional infrastructure is unavailable.
...
- **Dates:** Saturday, June 26 -- Sunday, June 27, 2027
