---
title: "Discord Quick Start Guide"
date: 2026-02-09
description: "A beginner-friendly guide to getting started with Discord for amateur radio operators"
...
Discord is a communication platform that lets you interact through text, voice, and video. It works on desktop (Windows, Mac, Linux), mobile (iOS, Android), and in your web browser at [discord.com](https://discord.com). Think of it as a mix between group chat and a forum, but in real time.

## Creating an Account

1. Go to [discord.com](https://discord.com) or download the app from your device's app store
2. Click **Register**
...
| Bold | \*\*text\*\* | **text** |
| Italic | \*text\* | *text* |
| Underline | \_\_text\_\_ | __text__ |
...
- [Disboard - Ham Radio Servers](https://disboard.org/servers/tag/ham-radio) -- Directory of ham radio Discord servers
- [OARC - Online Amateur Radio Community](https://discord.gg/BQHuFbUG3P)
- [HHRC - Ham Radio Crash Course](https://canary.discord.com/invite/5Jrvazgm)
- [The HamShack](https://discord.com/invite/S5ngBG5A2w)

## Learn More

- [Discord Beginner's Guide](https://support.discord.com/hc/en-us/articles/360045138571-Beginner-s-Guide-to-Discord) -- Official Discord help article
- [Discord Basics](https://support.discord.com/hc/en-us/categories/115000217151-Discord-Basics) -- Full help center
